...
function Contact() {
  ...
  const handleSubmit=(e)=>{
    e.preventDefault();
    console.log("Submission of form working");
  }
  return (
    <section className=" dark:bg-black dark:text-white">
      <div className="flex justify-center dark:bg-black text-white w-full bg-opacity-60" style={{backgroundImage:`url(https://media.istockphoto.com/id/1213738982/photo/male-college-professor-gestures-during-lecture.jpg?s=612x612&w=0&k=20&c=vPvCqzyq3VUzjCaU-PoMaxC1ncK386Q78Cdp7bUj2Mw=)`,backgroundSize:"cover",backgroundPosition:"center",backgroundClip:"content-box",backgroundRepeat:"no-repeat" }}>
        <div className=" flex w-4/5 items-center h-[50vh]  dark:text-white">
      ...
      <div className="form lg:w-4/5 lg:h-[75vh] flex m-auto md:w-full dark:bg-black dark:text-white">
        <div className="form lg:w-[60%] md:w-full  h-full bg-slate-300">
          <div className="form-values px-10 py-12 dark:bg-[#181a1b] dark:text-white">
            ...
            <form action="" onSubmit={handleSubmit}>
              ...
              <div className="flex justify-center">
                ...
                <button className="justify-center whitespace-nowrap font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 border px-6 h-12 py-1 flex items-center gap-3 xl:text-xl text-lg lg:h-[4rem] hover:bg-brand rounded-[0.4rem] lg:mt-4 hover:bg-[#333f90]">
                  Submit ↗️
                </button>
              </div>
            </form>
