...
import logo from '../header/user.png'
function Footer() {
  return (
    <footer className="bg-white border-y dark:bg-black dark:border-gray-700">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-500 font-medium">
                                ...
                                <li>
                                    <Link to="#about-section" className="hover:underline dark:text-white">
                                        About
                                    </Link>
                                </li>
                            </ul>
